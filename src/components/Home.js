...
export default function Home () { // url coming from searchForm as props
    ...
    // Top Movie Links
    const topMovies = ['Transformers', 'Terminator', 'Batman', 'Spider Man', 'Tron Legacy', 'Kill Bill', 'Star Wars'];
    let keyval = 1;
    ...
    return (
        ...
        <header className={ !url ? 'heading' : 'heading search' }>
        ...
        <footer className={ !url ? 'footer' : 'footer search' }>
            <Footer />
        </footer>
